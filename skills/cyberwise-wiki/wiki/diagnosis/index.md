...
- [A pile of crash reports is a dataset, and it needs a denominator](/diagnosis/reading-a-crash-corpus) - dedupe on crashVisitId, why district counts need a base rate, matched-uptime comparison, and the bimodality that hides two faults in one report
